...
import { SuccessModalComponent } from './pages/modals/success-modal/success-modal/success-modal.component';
import { FailureModalComponent } from './pages/modals/failure-modal/failure-modal/failure-modal.component';
