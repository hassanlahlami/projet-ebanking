...
public class ClientController {
    ...
    public boolean postToken(@PathVariable("id") long id) throws MessagingException {
        ...
        mailservice.javasend(client.getEmail(), savedToken, "validation token", "token");
        return true;
    }
    ...
    public boolean sendTokenForEcode(@PathVariable("clientId") long clientId) throws MessagingException {
        ...
        String savedToken = tokenmailservice.savetoken(token, client).getToken();
        mailservice.sendTokenEmail(client.getEmail(), savedToken, "validation token pour E-Code");
        return true;
    }
    ...
    public boolean update(@RequestBody Clientchangedto clientchangedto,
    ...
    @GetMapping("/alltoken")
    public List<tokenmail> getAllTokens() {
        return tokenMailRepo.findAll();
    }

    @DeleteMapping("/delete/token/{id}")
    public void deleteToken(@PathVariable("id") long id) {
        tokenMailRepo.deleteById(id);
    }
