...
public class Cryptocontroller {
    ...
    @PostMapping("/crypto")
    public boolean Crypto(@RequestBody AcheteDto acheteDto,@RequestParam("rib") String rib) {
    ...
    public boolean Vendre(@RequestBody Vendredto vendredto,@RequestParam("rib") String rib) {
