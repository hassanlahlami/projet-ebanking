...
public class mail {
        ...
        private String bankinhoMail = "bankinho.mybyhi@gmail.com";
    ...
    public String sendMailForEcode() {
        try {
            // Générer un e-code à 6 chiffres
            int ecodeVerification = 100000 + new Random().nextInt(900000);

            // Préparer l'email
            MimeMessage message = sender.createMimeMessage();
            MimeMessageHelper helper = new MimeMessageHelper(message, true);
            helper.setFrom(bankinhoMail);
            helper.setTo("loubnaalaoui2003@gmail.com");
            helper.setSubject("Confirmez votre identité");
            ...
            String htmlMsg = "<html>" +
                    ...
                    + "<h2 style='color: #004080;'>Confirmation de votre E-Code</h2>"
                    + "<p>Vous avez demandé la génération d’un nouveau code de sécurité (E-Code) pour votre compte bancaire.</p>"
